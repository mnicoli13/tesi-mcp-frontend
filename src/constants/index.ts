...
export const INTERVIEW_STEP_DESCRIPTIONS = {
  ...
  [INTERVIEW_STEPS.EXAMS]:
    "Connetti ESSE3 o inserisci manualmente gli esami sostenuti",
  [INTERVIEW_STEPS.INTERESTS]:
    "Indica le tue preferenze professionali e di carriera",
  [INTERVIEW_STEPS.EXPERIENCES]: "Aggiungi progetti e esperienze lavorative",
  [INTERVIEW_STEPS.SKILLS]:
    "Specifica le tue competenze tecniche e linguistiche",
} as const;
...
export const MCP_TOOLS = {
  ...
  SUGGEST_CAREERS: "suggest_career_job_roles",
  GENERATE_CV: "generate_cv_europass",
  FIND_JOBS: "find_jobs",
} as const;

export const MCP_TOOL_DESCRIPTIONS = {
  [MCP_TOOLS.EXTRACT_SKILLS]:
    "Analizza gli esami e identifica le competenze acquisite",
  [MCP_TOOLS.SUGGEST_CAREERS]:
    "Suggerisce ruoli professionali e job families in base al tuo profilo",
  [MCP_TOOLS.GENERATE_CV]: "Genera un curriculum Europass personalizzato",
  [MCP_TOOLS.FIND_JOBS]:
    "Cerca offerte di lavoro reali in base ai tuoi criteri",
} as const;
