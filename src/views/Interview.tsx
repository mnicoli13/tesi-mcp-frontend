...
const Interview: React.FC = () => {
  ...
  const handleNext = async () => {
    ...
    try {
      ...
      setValidationError(
        error.response?.data?.message || 'Errore nel salvataggio dei dati. Riprova.'
      );
    } finally {
      setIsSaving(false);
    }
      ...
      <Box py={4}>
        ...
        <Box mb={4}>
          ...
          <Typography variant="body1" color="text.secondary">
            Completa i seguenti step per creare un profilo completo e ricevere suggerimenti
            personalizzati per la tua carriera.
          </Typography>
        </Box>
            ...
            <Box display="flex" justifyContent="space-between" width="100%" gap={2}>
              ...
              <Box display="flex" gap={2}>
                ...
                >
                  {isSaving 
                    ? 'Salvataggio...' 
                    : currentStep === InterviewStep.SKILLS ? 'Completa' : 'Avanti'}
                </Button>
              </Box>
            </Box>
          </CardActions>
        ...
        <Alert severity="info" sx={{ mt: 3 }}>
          <strong>Info:</strong> I tuoi dati vengono salvati automaticamente. Puoi tornare
          indietro e modificare le tue risposte in qualsiasi momento.
        </Alert>
      </Box>
      ...
      >
        ...
        <DialogContent>
          ...
          <Typography variant="body2" color="text.secondary" paragraph>
            Il tuo profilo verrà salvato e potrai iniziare a utilizzare il Career Coach AI per
            ricevere suggerimenti personalizzati, generare il tuo CV Europass e cercare opportunità
            di lavoro.
          </Typography>
        ...
        <DialogActions>
          <Button onClick={() => setShowCompletionDialog(false)} disabled={isLoading}>
            Rivedi
          </Button>
          <Button
            variant="contained"
